...
class RestaurantsFragment : Fragment() {
    ...
    private var mRestaurantList = ArrayList<Restaurant>()
    ...
    override fun onCreateView(
        ...
        mFilterRecyclerView.layoutManager = LinearLayoutManager(activity, LinearLayoutManager.HORIZONTAL, false)
        ...
        mFilterAdapter.setOnItemClickListener(object : ClickListener {
            override fun onItemClick(label: String) {
                ...
                if (label == mLabelSelected) {
                    ...
                    mRestaurantsListAdapter.setRestaurantsList(ArrayList(sortedRList))
        ...
        model.getRestaurants.observe(viewLifecycleOwner, {
            mRestaurantList = it
            mRestaurantsListAdapter.setRestaurantsList(it)
        })

        model.getFilters.observe(viewLifecycleOwner, {
            mFilterAdapter.setCategories(it)
        })
